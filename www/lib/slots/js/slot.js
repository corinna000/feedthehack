...
function preloadImages(images, callback) {
    ...
    function _preload(asset) {
        asset.img = new Image();
        // asset.img.src = 'lib/slots/img/' + asset.id+'.png';
        asset.img.src = 'img/trucks/' + asset.id + '.png';
...
function _initWebAudio(AudioContext, format, audios, callback) {
    ...
    function _preload(asset) {
        ...
        request.open('GET', 'lib/slots/audio/' + asset.id + '.' + format, true);
...
function _initHTML5Audio(format, audios, callback) {
    ...
    function _preload(asset) {
        asset.audio = new Audio('lib/slots/audio/' + asset.id + '.' + format);
...
//            console.log("finished spinning");
            ...
            var res1 = that.items1[that.result1].id,
                res2 = that.items2[that.result2].id,
                res3 = that.items3[that.result3].id;
